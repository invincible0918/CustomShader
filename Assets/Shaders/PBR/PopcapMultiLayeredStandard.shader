Shader "Popcap/PBR/MultiLayered/Standard" 
{
    Properties
    {	
    ...
    CGINCLUDE
        #define POPCAP_SETUP_BRDF_INPUT MetallicSetupWithMultiLayered
    ENDCG
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#include "__PopcapPBRWithMultiLayered.cginc"
    ...
    FallBack "VertexLit"
    CustomEditor "PopcapMultiLayeredGUI"
}
