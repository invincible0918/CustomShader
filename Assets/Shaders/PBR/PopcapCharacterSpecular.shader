Shader "Popcap/PBR/Character/Specular" 
{
    Properties	
    {
	...
	SubShader
	{
		...
		UsePass "Popcap/PBR/Character/__Passes/STENCIL"
		UsePass "Popcap/PBR/Character/__Passes/FORWARD"
	}
	...
	SubShader
	{
		...
		GrabPass { "_GrabScreenRenderTexture" }
		UsePass "Popcap/PBR/Character/__Passes/STENCIL"
		UsePass "Popcap/PBR/Character/__Passes/FORWARD"
		//UsePass "Popcap/PBR/Character/__Passes/SHADOW_CASTER"
		GrabPass { "_GrabTexture"}
		UsePass "Popcap/PBR/Character/__Passes/DOWN_SAMPLE"
		GrabPass { "_BlurVertical"}
		UsePass "Popcap/PBR/Character/__Passes/VERTICAL_BLUR"
		GrabPass { "_BlurHorizontal"}
		UsePass "Popcap/PBR/Character/__Passes/HORIZONTAL_BLUR"
	}
	...
	SubShader
	{
		...
		//Tags { "RenderType" = "Opaque" "PerformanceChecks" = "False" }
		UsePass "Popcap/PBR/Character/__Passes/FORWARD"
		UsePass "Popcap/PBR/Character/__Passes/STENCIL_ENABLE_ICE"
		UsePass "Popcap/PBR/Character/__Passes/FORWARD_ENABLE_ICE"
	}
