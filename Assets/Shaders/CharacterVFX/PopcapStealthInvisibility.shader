Shader "Popcap/CharacterVFX/StealthInvisibility" 
{
    Properties	
    {
	...
	SubShader
    {
		...
		// Grab the screen behind the object into _GrabScreenRenderTexture
		GrabPass
		{
        ...
        Pass
        {
			...
			#include "__PopcapStealthInvisibility.cginc"
